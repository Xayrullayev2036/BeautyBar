...
SECRET_KEY = 'django-insecure-%n&6bv)_xl1d-!jme@h+qr+8ofj3g0dmc5b%0cjz$mrfoh!*p3'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "BeautyBar Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "BeautyBar",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "BeautyBar",

    # Logo to use for your site, must be present in static files, used for brand on top left
    "site_logo": "media/BeautyBar.png",
    ...
    "welcome_sign": "Welcome to the BeautyBar",

    # Copyright on the footer
    "copyright": "Acme BeautyBar Ltd",
    ...
    "topmenu_links": [
        ...
        {"name": "Support", "url": "https://mail.google.com/mail/u/0/#inbox", "new_window": True},
